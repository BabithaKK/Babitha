public class ScissorRunner{
    public static void main(String[] args) 
    {
        ...
        Scissors ref1=new Scissors("Tailor Scissors");
        ...
        Scissors ref2=new Scissors("Tailor Scissors","Gold");
        ...
        Scissors ref3=new Scissors("Tailor Scissors","Gold","sharpestBlade");
        ...
        Scissors ref4=new Scissors("Tailor Scissors","Gold","sharpestBlade","Hospital");
        ...
        Scissors ref5=new Scissors("Tailor Scissors","Gold","sharpestBlade","Hospital",'S');
        ...
        Scissors ref6=new Scissors("Tailor Scissors","Gold","sharpestBlade","Hospital",'S',2000);
        ...
        Scissors ref7=new Scissors("Tailor Scissors","Gold","sharpestBlade","Hospital",'S',2000,"Steel");
